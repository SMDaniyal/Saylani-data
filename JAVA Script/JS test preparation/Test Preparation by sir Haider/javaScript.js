...
// answer is false because true = 1 & false = 0




//  var num = "10";
// // alert(+num--);        //concatinate doesnot effect first ans will be 10
// // alert(num);           //after post decrement 10 became 9 so ans will be 9 



// num = 10++;              //no ans beacause increment and decrement doesnot work in variable
// alert(num)
...
// var num = 10;
// num = num + num++;      // 10 = 10 + 10(+1) but this is post increment before increment the value of num is decleared in num as 20
// alert(num);
// alert(num);
...
// var num = 10;
// num = num++ - num-- + num;
// //10 = 10 - 11 + 10   // ans is 9 
// alert(num)


// var num = "10";
// num = num-- + num-- + num--;  // ans is 27 (first it do the simple math operation so ans is 30 then it decrement 3 time 27 is ans)
// alert(num)
...
//  if (false) { alert("if") }
// else { alert("else") }               // ajsdijajdoiasjidjisajdijasdj/////
